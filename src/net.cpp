...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Premine " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    {"bitcoin.petertodd.org", "testnet-seed.premine.petertodd.org"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Premine is probably already running."), addrBind.ToString().c_str());
        else
