...
unlocked to sign the Premine-Qt.app bundle.
...
allowing somebody to distribute a Premine-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the premine-qt.exe file inside the installer had not been tampered with.
